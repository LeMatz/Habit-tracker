...
import ThresholdConsole from '../components/ThresholdConsole';
import OpportunityConsole from '../components/OpportunityConsole';
...
const Home: React.FC = () => {
  ...
  if (settings.habitType === 'threshold') {
    return (
  ...
  if (settings.habitType === 'opportunity') {
    return (
      <div className="p-6 pb-20">
        <OpportunityConsole />
      </div>
